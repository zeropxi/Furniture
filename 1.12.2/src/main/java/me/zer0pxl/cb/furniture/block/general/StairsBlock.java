...
import static me.zer0pxl.cb.furniture.block.general.StairsBlock.EnumHalf.BOTTOM;
import static me.zer0pxl.cb.furniture.block.general.StairsBlock.EnumHalf.TOP;
import static me.zer0pxl.cb.furniture.block.general.StairsBlock.EnumShape.*;
...
public class StairsBlock extends DefaultHorizontalBlock {
	...
	public IBlockState getStateFromMeta(int meta) {
		...
		iblockstate = iblockstate.withProperty(FurnitureHorizontalBlock.DIRECTION, EnumFacing.byIndex(5 - (meta & 3)));
		return iblockstate;
	}
