...
public abstract class MixinBeaconTileEntity extends TileEntity implements ITickable {
	...
	@Redirect(method = "updateSegmentColors", at = @At(value = "INVOKE", target = "Ljava/util/List;add(Ljava/lang/Object;)Z"))
	public boolean redirectUpdateSegmentColors(List<TileEntityBeacon.BeamSegment> list, Object object) {
		TileEntityBeacon.BeamSegment beamSegment = (TileEntityBeacon.BeamSegment) object;
		IBlockState blockState = getWorld().getBlockState(getPos());
